...
def test_estimate_tokens_fallback():
    # Force the exception path by patching tiktoken with create=True
...
def test_format_messages_tool_calls_reconstruction():
    ...
    msg = Message(role="assistant", content="calling tool", tool_call_id="call_1", tool_name="search", tool_arguments={"q": "test"})
